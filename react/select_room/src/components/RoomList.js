...
const RoomList = (props) => {
    ...
    const handleClickOpen = (isPassRequired) => {
        if(isPassRequired === "Yes"){
            setOpen(true);
        }
    };
                                                ...
                                                <TableCell key={column.id} align={column.align}>
                                                    {
                                                        !(column.id === "joinButton") ? value : (
                                                            <Button color="primary" variant="contained" onClick={() => handleClickOpen(row["passRequired"])}>
                                                                JOIN
                                                            </Button>
                                                        )
                                                    }
